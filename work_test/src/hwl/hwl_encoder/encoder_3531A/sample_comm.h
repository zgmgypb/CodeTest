...
typedef enum 
{
	VI_MODE_D1_1MUX_SINGLE,
	VI_MODE_1080I_BT1120_1MUX_SINGLE,
	VI_MODE_720P_BT1120_1MUX_SINGLE,
	VI_MODE_1080P_BT1120_1MUX_SINGLE
} VI_MODE_E;
...
{
	HI_S32 m_ViDevCnt;        
	HI_S32 m_ViDevInterval;    
	HI_S32 m_ViChnCnt;          
	HI_S32 m_ViChnInterval;   
	...
	struct stViDevParam {
		...
		} m_ViChnParam[VIU_MAX_CHN_NUM_PER_DEV];
	} m_ViDevParam[VIU_MAX_DEV_NUM];
} VI_PARAM_S;

typedef struct {
	VENC_CHN		m_VencChn;

	VENC_CHN_ATTR_S	m_VencChnAttr; /* 编码通道参数 */
} VENC_PARAM_S;
